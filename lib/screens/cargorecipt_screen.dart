...
import '../models/cargoreciptmodel.dart';
import '../widgets/custom_button.dart';

class CargoReciptScreen extends StatefulWidget {
  const CargoReciptScreen({super.key});

  @override
  State<CargoReciptScreen> createState() => _CargoReciptScreenState();
}

class _CargoReciptScreenState extends State<CargoReciptScreen> {
  // TODO Create a list of dummy data
  final List<CargoReciptModel> dummyData = [
    CargoReciptModel(
      invoiceNumber: '7521355',
      presentDate: '28/8/2023',
      fileImageUrl:
      'assets/images/bottle.jpg',
    ),
    CargoReciptModel(
      invoiceNumber: '1234567',
      presentDate: '29/8/2023',
      fileImageUrl:
      'assets/images/bottle.jpg',
    ),
    CargoReciptModel(
      invoiceNumber: '9876543',
      presentDate: '30/8/2023',
      fileImageUrl:
      'assets/images/bottle.jpg',
    ),
    CargoReciptModel(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const CustomButton(
              text: "Lottery Receipt / Cargo Receipt",
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        height: 35.0,
                        child: ListTile(
                          title: const Text("Present Date"),
                          trailing: Text(dataItem.presentDate),
                        ),
                      ),
                      SizedBox(
                        height: 35.0,
