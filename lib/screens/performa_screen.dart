...
class _PerformaScreenState extends State<PerformaScreen> {
  ...
  // final List<PerformaModel> dummyData = [
  //   PerformaModel(
  //     performaNo: '7521355',
  //     date: '28/8/2023',
  //     fileImageUrl:
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<PerformaProvider>(context, listen: false).getAllPerformaList();
    });
  }
        ...
        children: [
          ...
          Consumer<PerformaProvider>(
              builder: (context, value, child){
                ...
                final performas = value.performaProvider;
                return  Expanded(
                  child: ListView.builder(
                    physics: const BouncingScrollPhysics(),
                    itemCount: performas?.length,
                    itemBuilder: (context, index) {
                      var dataItem = performas![index];
                            ...
                            SizedBox(
                              ...
                              child: ListTile(
                                title: const Text("Performa No."),
                                  trailing: Text(dataItem.proformaNo.toString()),
                              ),
                            ),
                            SizedBox(
                              height: 35.0,
                              child: ListTile(
                                ...
                                trailing: Text(dataItem.date.toString()),
                              ),
                            ),
                            SizedBox(
                              height: 35.0,
